...
public class CalculateClass {
     ...
     */
    public static double getDispertion(double[] proc){
        var n = proc.length;
     ...
     */
    public static double getAsymmetryCoefficient(double[] proc){
        var n = proc.length;
     ...
     */
    public static double getKurtosisCoefficient(double[] proc){
        var n = proc.length;
